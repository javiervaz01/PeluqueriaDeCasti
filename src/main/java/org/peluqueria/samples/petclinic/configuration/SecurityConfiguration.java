package org.peluqueria.samples.petclinic.configuration;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/phonenumber/**").authenticated()
				.antMatchers("/adoptions/**").permitAll()
				.antMatchers("/CA/**").permitAll()
				.antMatchers("/support/**").permitAll()
				.antMatchers("/plan/**").hasAnyAuthority("clinicOwner")
				.antMatchers("/clinics/**").hasAnyAuthority("clinicOwner")
