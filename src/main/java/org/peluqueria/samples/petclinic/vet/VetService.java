...
public class VetService {
	...
	@Transactional(readOnly = true)
	public Optional<Vet> findVetById(Integer id) throws DataAccessException {
	...
	public List<Specialty> findAllSpecialties() throws DataAccessException {
		return vetRepository.findAllSpecialties().stream().collect(Collectors.toList());
	}
	
	public Specialty findSpecialtyByName(String name){
		return vetRepository.findSpecialtyByName(name).get();
	}
